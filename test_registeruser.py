...
def test_register_duplicate_username(register_page):
    ...
    register_page.submit()
    expect(register_page.page.get_by_text("Username already taken")).to_be_visible(timeout=10000)
...
def test_register_duplicate_email(register_page):
    ...
    register_page.submit()
    expect(register_page.page.get_by_text("Email already registered")).to_be_visible(timeout=10000)
...
def test_password_rules_validation(register_page):
    ...
    uppercase_rule = page.locator('[data-testid="password-rules"] li', has_text="One uppercase letter")
    ...
    uppercase_rule = page.locator('[data-testid="password-rules"] li', has_text="One uppercase letter")
    special_char_rule = page.locator('[data-testid="password-rules"] li', has_text="One special character")
